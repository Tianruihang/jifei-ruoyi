<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="点数" prop="limitAmount">
        <el-input
    ...
    <el-table v-loading="loading" :data="exchangeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="点数" align="center" prop="limitAmount" />
      <el-table-column label="兑换金额" align="center" prop="amount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="点数" prop="limitAmount">
          <el-input v-model="form.limitAmount" placeholder="请输入点数" />
        </el-form-item>
        <el-form-item label="兑换金额" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入兑换金额" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createDate">
          <el-date-picker clearable
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除积分与余额兑换公式编号为"' + ids + '"的数据项？').then(function() {
