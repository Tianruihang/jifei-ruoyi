<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="消耗点数" prop="limitAmount">
        <el-input
    ...
    <el-table v-loading="loading" :data="ruleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="消耗点数" align="center" prop="limitAmount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="消耗点数" prop="limitAmount">
          <el-input v-model="form.limitAmount" placeholder="请输入消耗点数" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createDate">
          <el-date-picker clearable
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        limitAmount: [
          { required: true, message: "消耗点数不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除积分消费规则编号为"' + ids + '"的数据项？').then(function() {
        return delRule(ids);
      }).then(() => {
        this.getList();
